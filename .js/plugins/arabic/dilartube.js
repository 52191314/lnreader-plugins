...
var dilartube = /** @class */ (function () {
    ...
    dilartube.prototype.parseNovel = function (novelUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var chapterItems, fullUrl, chapterUrl, manga, chapters, mangaData, chapterData, novel, translationStatusId, translationText, mainGenres, statusId, statusText;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        novel = {
                            path: novelUrl,
                            name: (_b = (_a = mangaData.arabic_title) !== null && _a !== void 0 ? _a : mangaData.title) !== null && _b !== void 0 ? _b : 'Untitled',
                        ...
                        translationStatusId = mangaData.translation_status.toString();
                        translationText = {
                            '1': 'مستمره',
                            '0': 'منتهية',
                            '2': 'متوقفة',
                        ...
                        mainGenres = Array.from(new Set(mangaData.categories.map(function (g) { return g.name; })))
                            .filter(Boolean)
                            .join(',');
                        novel.genres = "".concat(translationText, ",").concat(mainGenres);
                        statusId = mangaData.story_status.toString();
                        statusText = {
                            '2': 'Ongoing',
                            '3': 'Completed',
                        }[statusId] || 'Unknown';
    ...
    dilartube.prototype.searchNovels = function (searchTerm) {
        return __awaiter(this, void 0, void 0, function () {
