                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if ((_a = this.options) === null || _a === void 0 ? void 0 : _a.customJs) {
                            try {
                                chapterText.find('span[style*="opacity: 0; position: fixed;"],[role="presentation"]').remove();
                            }
                            catch (error) {
