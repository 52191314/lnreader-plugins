...
var BlogDoAnonNovelsPlugin = /** @class */ (function () {
    ...
    BlogDoAnonNovelsPlugin.prototype.parseNovels = function (json) {
        ...
        result.feed.entry.forEach(function (n) {
            ...
            var novelUrl = (_a = n.link.find(function (t) { return 'alternate' == t.rel; })) === null || _a === void 0 ? void 0 : _a.href;
            if (!novelUrl)
                return;
            var coverUrl = (_b = n.media$thumbnail) === null || _b === void 0 ? void 0 : _b.url.replace('/s72-c/', '/w340/');
            var novel = {
                name: novelName,
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        result.feed.entry.forEach(function (n) {
                            ...
                            var chapterUrl = (_a = n.link.find(function (t) { return 'alternate' == t.rel; })) === null || _a === void 0 ? void 0 : _a.href;
                            var releaseTime = n.updated ? new Date(n.updated.$t) : null;
                            if (!chapterUrl)
                                return;
                            ...
                            chapters.push({
                                name: chapterName,
                                path: chapterUrl.replace(_this.site, ''),
                                releaseTime: releaseTime === null || releaseTime === void 0 ? void 0 : releaseTime.toISOString(),
