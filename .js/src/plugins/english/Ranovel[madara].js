...
var MadaraPlugin = /** @class */ (function () {
    function MadaraPlugin(metadata) {
        ...
        this.version = ((_b = metadata.options) === null || _b === void 0 ? void 0 : _b.version) || "2.2.".concat(versionIncrements);
    ...
    MadaraPlugin.prototype.popularNovels = function (pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function (pageNo, _b) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        url = ((_d = this.options) === null || _d === void 0 ? void 0 : _d.browsePage)
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if ((_a = this.options) === null || _a === void 0 ? void 0 : _a.customJs) {
                            try {
                                loadedCheerio('img[alt="Buy Me a Coffee at ko-fi.com"]').parent().remove();
                                loadedCheerio('*').contents().each(function () { if (this.type === 'comment' && this.data.trim() === 'Text Ranovel') {
                                    var currentNode = this.next;
                                    for (var i = 0; i < 2 && currentNode; i++) {
                                        var nextNode = currentNode.next;
                                        loadedCheerio(currentNode).remove();
