...
var NovelArrow = /** @class */ (function () {
    ...
    NovelArrow.prototype.parseNovel = function (novelPath) {
        return __awaiter(this, void 0, void 0, function () {
            var url, result, $, novelId, genres, genreList_1, fullSummary, novel, chaptersUrl, chaptersJson, e_1, chaptersMap, combinedRegex, match, path, name_1, fullPath;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        genres = $('meta[name="og:novel:genre"], meta[property="og:novel:genre"]').attr('content');
                        if (!genres) {
                            genreList_1 = [];
                        ...
                        fullSummary = $('.site-reading-copy p')
                        ...
                        novel = {
                            ...
                            status: $('meta[name="og:novel:status"]').attr('content') === 'Ongoing'
