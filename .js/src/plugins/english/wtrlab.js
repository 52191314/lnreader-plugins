...
var WTRLAB = /** @class */ (function () {
    ...
    WTRLAB.prototype.popularNovels = function (page_1, _a) {
        return __awaiter(this, arguments, void 0, function (page, _b) {
            var link, params, response, recentNovel, novels, finderPage, finderCheerio, nextData, buildId, response, json, seenIds_1, novels;
            var _this = this;
            var _c, _d, _e, _f;
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 3: return [4 /*yield*/, (0, fetch_1.fetchApi)(this.site + 'en/novel-finder').then(function (res) { return res.text(); })];
                    case 4:
                        finderPage = _g.sent();
    ...
    WTRLAB.prototype.parseNovel = function (novelPath) {
        return __awaiter(this, void 0, void 0, function () {
            var body, loadedCheerio, baggage, trace, nextDataElement, nextDataText, rawId, slug, chapterCount, novel, jsonData, serieData, genres, tags, existingGenres, allGenres_1, uniqueGenres, urlMatch, chapterCountText, chapterCountMatch, jsonData, chapters, error_1;
                    ...
                    case 4:
                        ...
                        if (nextDataText) {
                            try {
                                ...
                                serieData = (_c = (_b = (_a = jsonData === null || jsonData === void 0 ? void 0 : jsonData.props) === null || _a === void 0 ? void 0 : _a.pageProps) === null || _b === void 0 ? void 0 : _b.serie) === null || _c === void 0 ? void 0 : _c.serie_data;
                        ...
                        genres = loadedCheerio('td:contains("Genre")')
                            .next()
                            .find('a')
                            .map(function (i, el) {
                        ...
                        if (genres.length > 0) {
                            novel.genres = genres
                                .map(function (g) { return g.replace(/,$/, '').trim(); })
                                .filter(function (genre) { return genre && genre.length > 0; })
                                .join(', ');
                        }
                        tags = loadedCheerio('td:contains("Tags")')
                            .next()
                            .find('a')
                            .map(function (i, el) {
                            return loadedCheerio(el)
                        ...
                        if (tags.length > 0) {
                            existingGenres = novel.genres ? novel.genres.split(', ') : [];
                            allGenres_1 = __spreadArray(__spreadArray([], existingGenres, true), tags, true).filter(function (genre) { return genre && genre.length > 0; });
                            uniqueGenres = allGenres_1.filter(function (genre, index) { return allGenres_1.indexOf(genre) === index; });
                            ...
                            novel.status =
                                loadedCheerio('td:contains("Status")')
                                    ...
                                    loadedCheerio('td:contains("Status") + td')
                                        ...
                                        .replace(/[\t\n]/g, '')
                                        .trim() ||
                                    ((_h = loadedCheerio('.detail-line:contains("•")')
                                        .text()
                                        .match(/•\s*(\w+)/)) === null || _h === void 0 ? void 0 : _h[1]) ||
                                    '';
                        }
                        ...
                        if (chapterCount === 0 && nextDataText) {
                            try {
                                jsonData = JSON.parse(nextDataText);
                                chapterCount =
                                    (_o = (_m = (_l = (_k = (_j = jsonData === null || jsonData === void 0 ? void 0 : jsonData.props) === null || _j === void 0 ? void 0 : _j.pageProps) === null || _k === void 0 ? void 0 : _k.serie) === null || _l === void 0 ? void 0 : _l.serie_data) === null || _m === void 0 ? void 0 : _m.chapter_count) !== null && _o !== void 0 ? _o : 0;
                            }
                            catch (error) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, fetch_1.fetchApi)('https://translate-pa.googleapis.com/v1/translateHtml', {
                                ...
                                'body': "[[".concat(JSON.stringify(contained), ",\"zh-CN\",\"en\"],\"te_lib\"]"),
                                'method': 'POST',
                            })];
                    case 1:
                        response = _a.sent();
