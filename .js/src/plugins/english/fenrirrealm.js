...
var FenrirRealmPlugin = /** @class */ (function () {
    ...
    FenrirRealmPlugin.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            var chapterId, url_1, res, json, content, parsedContent, $_1, url, result, body, loadedCheerio, chapterText, jsonUrl, jsonRes, json, nodes, data, contentStr, contentJson, e_1;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (content) {
                            try {
                                ...
                                $_1 = (0, cheerio_1.load)(content);
                                // Remove anti-scraping tags and inline CSS
                                $_1('div[aria-hidden="true"]').remove();
                                $_1('p[aria-hidden="true"]').remove();
                                $_1('.reader-attribution').remove();
                                $_1('[data-fr-attr]').remove();
                                $_1('style').remove();
                                // Target any remaining text elements containing copy references or bookmarks
                                $_1('p, div, span, small').each(function (_, el) {
                                    var text = $_1(el).text().trim();
                                    if (text.startsWith('Copy reference:') ||
                                        text.startsWith('Bookmark:')) {
                                        $_1(el).remove();
                                    }
                                });
                                return [2 /*return*/, $_1.html() || content];
                            }
                        }
                        _b.label = 3;
                    case 3:
                    ...
                    case 5:
                        ...
                        chapterText = loadedCheerio('.reader-area p, div.content-area p, [id^="reader-area"] p')
                            .map(function (_, el) {
                            var _a;
                            var html = (_a = loadedCheerio(el).html()) === null || _a === void 0 ? void 0 : _a.trim();
                            return html ? "<p>".concat(html, "</p>") : '';
                        })
                            .get()
                            .filter(Boolean)
                            .join('\n');
    ...
    FenrirRealmPlugin.prototype.resolveUrl = function (path) {
        return "".concat(this.site, "/series/").concat(path.split('~~')[0]);
    };
