...
var ReN = /** @class */ (function () {
    ...
    ReN.prototype.popularNovels = function (pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function (pageNo, _b) {
            var params, _loop_1, _i, _c, _d, type, filter, url, results, novels;
            var _this = this;
            var _e, _f;
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        _loop_1 = function (type, filter) {
                            var value = filter.value;
                            if (Array.isArray(value)) {
                                value.forEach(function (v) { return params.append(type, v); });
                            }
                            else if (typeof value === 'object' && value !== null) {
                                (_e = value.include) === null || _e === void 0 ? void 0 : _e.forEach(function (v) { return params.append(type, v); });
                                (_f = value.exclude) === null || _f === void 0 ? void 0 : _f.forEach(function (v) {
                                    return params.append("exclude_".concat(type), v);
                                });
                            }
                        };
                        for (_i = 0, _c = Object.entries(filters); _i < _c.length; _i++) {
                            _d = _c[_i], type = _d[0], filter = _d[1];
                            _loop_1(type, filter);
                        }
                        params.append('page', pageNo.toString());
                        url = "".concat(this.site, "/api/v2/search/catalog/?").concat(params.toString());
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(url).then(function (res) { return res.json(); })];
                    case 1:
                        results = (_g.sent()).results;
                        novels = results.map(function (novel) { return ({
    ...
    ReN.prototype.parseNovel = function (novelID) {
        return __awaiter(this, void 0, void 0, function () {
            var content, novel, tags, totalPages, branch_id, chapters, _loop_2, this_1, page, state_1;
            var _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, (0, fetch_1.fetchApi)(this.site + '/api/titles/' + novelID).then(function (res) { return res.json(); })];
                    case 1:
                        ...
                        novel = {
                            ...
                            status: content.status.name === 'Продолжается'
                                ? novelStatus_1.NovelStatus.Ongoing
                                : novelStatus_1.NovelStatus.Completed,
                        };
                        tags = [content === null || content === void 0 ? void 0 : content.genres, content === null || content === void 0 ? void 0 : content.categories]
                            .flat()
                        ...
                        _loop_2 = function (page) {
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    ...
                                    case 1:
                                        _f.sent();
                                        return [4 /*yield*/, (0, fetch_1.fetchApi)(this_1.site +
                                                '/api/titles/chapters/?branch_id=' +
                                                branch_id +
                                                '&ordering=index&user_data=1&count=100&page=' +
                                                (page + 1)).then(function (res) { return res.json(); })];
                                    case 2:
                                        volumes = _f.sent();
                                        skip = false;
    ...
    ReN.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            var url, result;
    ...
    ReN.prototype.searchNovels = function (searchTerm_1) {
