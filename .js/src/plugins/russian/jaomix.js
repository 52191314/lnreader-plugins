...
var Jaomix = /** @class */ (function () {
    ...
    Jaomix.prototype.parsePage = function (novelPath, page) {
        return __awaiter(this, void 0, void 0, function () {
            var body, loadedCheerio, chapters;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetch_1.fetchApi)("".concat(this.site, "/wp-admin/admin-ajax.php"), {
                            method: 'POST',
                            headers: {
    ...
    Jaomix.prototype.parseChapters = function (loadedCheerio) {
        var _this = this;
        var chapters = [];
        loadedCheerio('div.title').each(function (_, element) {
