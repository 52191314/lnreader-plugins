...
var Neobook = /** @class */ (function () {
    ...
    Neobook.prototype.fetchNovels = function (page, showLatestNovels, filters, searchTerm) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        formData.append('filter_category_id', ((_a = filters === null || filters === void 0 ? void 0 : filters.category) === null || _a === void 0 ? void 0 : _a.value) || '0');
                        formData.append('filter_completed', '-1');
                        formData.append('filter_search', searchTerm || '');
                        formData.append('filter_tags', ((_b = filters === null || filters === void 0 ? void 0 : filters.tags) === null || _b === void 0 ? void 0 : _b.value) || '');
                        formData.append('filter_sort', showLatestNovels ? 'new' : ((_c = filters === null || filters === void 0 ? void 0 : filters.sort) === null || _c === void 0 ? void 0 : _c.value) || 'popular');
                        formData.append('filter_timeread', ((_d = filters === null || filters === void 0 ? void 0 : filters.timeread) === null || _d === void 0 ? void 0 : _d.value) || '0-999999');
                    ...
                    case 1:
                        bundle_books = (_g.sent()).bundle_books;
                        novels = [];
                        if ((_e = bundle_books.feed) === null || _e === void 0 ? void 0 : _e.length) {
                            (_f = bundle_books.feed) === null || _f === void 0 ? void 0 : _f.forEach(function (novel) {
                                var _a, _b;
                                return novels.push({
                                    name: novel.title,
    ...
    Neobook.prototype.popularNovels = function (page_1, _a) {
