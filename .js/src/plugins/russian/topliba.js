...
var TopLiba = /** @class */ (function () {
    ...
    TopLiba.prototype.fetchNovels = function (page, showLatestNovels, filters, searchTerm) {
                ...
                switch (_c.label) {
                    case 0:
                        data = new URLSearchParams({
                            order_field: showLatestNovels ? 'date' : ((_a = filters === null || filters === void 0 ? void 0 : filters.sort) === null || _a === void 0 ? void 0 : _a.value) || 'rating',
                            p: page.toString(),
                        });
                        if (searchTerm)
                    ...
                    case 1:
                        body = _c.sent();
                        novels = [];
                        this._token = (_b = body.match(/<meta name="_token" content="(.*?)"/)) === null || _b === void 0 ? void 0 : _b[1];
    ...
    TopLiba.prototype.popularNovels = function (page_1, _a) {
