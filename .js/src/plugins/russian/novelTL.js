...
var TL = /** @class */ (function () {
    function TL() {
        ...
        this.resolveUrl = function (path) { return 'https://' + path; };
        this.filters = {
            tags: {
                label: 'Тэги',
                value: [],
    ...
    TL.prototype.fetchNovels = function (page, filters, searchTerm) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                            ...
                            body: JSON.stringify({
                                ...
                                variables: {
                                    filter: {
                                        ...
                                        tags: ((_b = (_a = filters === null || filters === void 0 ? void 0 : filters.tags) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.length)
                                            ? filters.tags.value
                                            : undefined,
                                        genres: ((_d = (_c = filters === null || filters === void 0 ? void 0 : filters.genres) === null || _c === void 0 ? void 0 : _c.value) === null || _d === void 0 ? void 0 : _d.length)
                    ...
                    case 1:
                        data = (_g.sent()).data;
                        novels = [];
                        (_f = (_e = data === null || data === void 0 ? void 0 : data.projects) === null || _e === void 0 ? void 0 : _e.content) === null || _f === void 0 ? void 0 : _f.forEach(function (novel) {
                            var _a, _b;
                            return novels.push({
                                name: novel.title,
                                path: novel.fullUrl,
                                cover: ((_b = (_a = novel === null || novel === void 0 ? void 0 : novel.covers) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.url)
                                    ? _this.site + novel.covers[0].url
    ...
    TL.prototype.popularNovels = function (page_1, _a) {
        return __awaiter(this, arguments, void 0, function (page, _b) {
            var filters = _b.filters;
            return __generator(this, function (_c) {
                return [2 /*return*/, this.fetchNovels(page, filters)];
            });
        });
    };
    TL.prototype.searchNovels = function (searchTerm, page) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.fetchNovels(page, undefined, searchTerm)];
            });
        });
    };
    TL.prototype.parseNovel = function (novelPath) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_q.label) {
                    ...
                    case 1:
                        ...
                        novel = {
                            ...
                            cover: ((_d = (_c = (_b = data.project) === null || _b === void 0 ? void 0 : _b.covers) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.url)
                            ...
                            status: statusKey[((_g = data.project) === null || _g === void 0 ? void 0 : _g.translationStatus) || 'unknown'] ||
                                novelStatus_1.NovelStatus.Unknown,
                        };
                        genres = [(_h = data.project) === null || _h === void 0 ? void 0 : _h.tags, (_j = data.project) === null || _j === void 0 ? void 0 : _j.genres]
                            .flat()
    ...
    TL.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
