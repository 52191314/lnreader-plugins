...
var AuthorToday = /** @class */ (function () {
    ...
    AuthorToday.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            var html, _a, workID, initialChapterID, chapterID, userRaw, userId, chapter, chapterJson, key, chapterText;
            var _b, _c, _d, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        html = _f.sent();
                        _a = chapterPath.split('/'), workID = _a[0], initialChapterID = _a[1];
