...
var RNBH = /** @class */ (function () {
    function RNBH() {
        ...
        this.resolveUrl = function (path) { return _this.site + '/ranobe/' + path; };
        this.filters = {
            sort: {
                label: 'Сортировка',
    ...
    RNBH.prototype.popularNovels = function (pageNo_1, _a) {
                ...
                switch (_r.label) {
                    case 0:
                        ...
                        url += showLatestNovels
                            ? 'last_chapter_at'
                            : ((_c = filters === null || filters === void 0 ? void 0 : filters.sort) === null || _c === void 0 ? void 0 : _c.value) || 'computed_rating';
                        ...
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(url + '&take=40').then(function (res) { return res.json(); })];
                    case 1:
    ...
    RNBH.prototype.parseNovel = function (novelPath) {
        return __awaiter(this, void 0, void 0, function () {
            var data, novel, tags, chapters, chaptersJSON;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, (0, fetch_1.fetchApi)(this.site + '/api/ranobe/' + novelPath).then(function (res) { return res.json(); })];
                    case 1:
                        data = (_c.sent()).data;
                        novel = {
                            path: novelPath,
                        ...
                        tags = [data.tags.events, data.tags.genres]
                            .flat()
                        ...
                        chapters = [];
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(this.site + '/api/ranobe/' + novelPath + '/contents').then(function (res) { return res.json(); })];
                    case 2:
    ...
    RNBH.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    RNBH.prototype.searchNovels = function (searchTerm) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        result = _c.sent();
                        novels = [];
                        (_b = (_a = result === null || result === void 0 ? void 0 : result.find(function (item) { var _a; return ((_a = item === null || item === void 0 ? void 0 : item.meta) === null || _a === void 0 ? void 0 : _a.key) === 'ranobe'; })) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.forEach(function (novel) {
                            var _a, _b, _c, _d;
                            return novels.push({
                                name: ((_a = novel === null || novel === void 0 ? void 0 : novel.names) === null || _a === void 0 ? void 0 : _a.rus) ||
                                    ((_b = novel === null || novel === void 0 ? void 0 : novel.names) === null || _b === void 0 ? void 0 : _b.eng) ||
                                    novel.name ||
                                    ((_c = novel === null || novel === void 0 ? void 0 : novel.names) === null || _c === void 0 ? void 0 : _c.original) ||
                                    '',
                                path: novel.id.toString(),
